...
@section('content')
    ...
    <div class="x-body" id="app" v-cloak>
        ...
        <div class="add_activity" style="margin-top: -50px" v-show="showBankForm">
            <form class="activity-form" style="width: 60%;margin-top: -50px">
                ...
                <div class="activity-form-left">
                    ...
                    <div class="layui-form-item">
                        <label for="L_email" class="layui-form-label">
                            <span class="x-red">*</span>银行
                        </label>
                        <div class="layui-input-inline" style="height:150px;width:300px;overflow:auto">
                            <el-checkbox-group v-model="checkedBank" @change="handleCheckedBankChange">
                                <el-checkbox v-for="bank in banks" :label="bank.id" :key="bank.id">@{{bank.name}}</el-checkbox>
                            </el-checkbox-group>
                        </div>
                    </div>
                </div>
                ...
                <div class="activity-form-right">
                    <div class="layui-form-item">
                        <label class="layui-form-label"><span class="x-red">*</span>优惠类型</label>
